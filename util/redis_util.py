from util.read_resource_file import REDIS_PORT, REDIS_HOST, REDIS_USER, REDIS_USER_PASSWORD
...
class RedisUtil:
    def __init__(self, host=f'{REDIS_HOST}', port=f'{6379}', db=0, password=f'{REDIS_USER_PASSWORD}'):
        """
            初始化Redis连接池
        :param host: 主机名
        :param port: 端口
    ...
    def get_sortSet_by_scoreRange(self, key, min, max, with_score=True):
        """
